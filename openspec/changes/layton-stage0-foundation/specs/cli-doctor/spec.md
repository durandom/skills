...
The `layton doctor` command validates system setup and dependencies. It's the first thing users run to verify their environment is correctly configured.

**Reference:** [agentic-cli.md](../../../../recipes/agentic-cli.md) — Hidden `--fix` flag pattern (Pattern 2: Hide Destructive Flags)
