---
name: para
description: PARA method for organizing notes by actionability (Projects, Areas, Resources, Archive). Use for categorization decisions, folder management, and maintaining your knowledge structure.
---
