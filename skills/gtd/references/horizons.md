...
| **H2** | Areas of Focus | Quarterly | `2 Areas/` folder (PARA) |
...
- H2 Areas already exist in your `2 Areas/` folder - don't duplicate them here
...
**Location:** `2 Areas/` folder in your b4brain vault
...
1. Am I neglecting any area in `2 Areas/`?
2. Are my projects balanced across areas?
3. Should I add or remove any areas?
4. Where am I overcommitted?

**Tip:** Run `ls "2 Areas/"` to review your current areas during quarterly review.
...
**Note:** H2 Areas live in `2 Areas/` folder, H3 Goals are GitHub Issues.
